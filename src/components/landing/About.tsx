...
export function About() {
  return (
    <div className="mx-auto w-full max-w-[1120px] px-5 sm:px-8">
      <div className="cine-scrim max-w-[68ch]">
        ...
        <div className="mt-7 space-y-4 text-[clamp(1rem,1.5vw,1.12rem)] leading-relaxed text-ink1">
          <p>
            ...
            <strong className="font-medium text-ink0">Computer Science</strong> and{" "}
            <strong className="font-medium text-ink0">Economics</strong> — and that
          ...
          <p>
            ...
            four ideas: <strong className="font-medium text-ink0">calibration</strong>{" "}
            (an uncertainty head that says when it doesn&apos;t know),{" "}
            <strong className="font-medium text-ink0">honest evaluation</strong> (catching
            my own data leak and reporting the worse, truer number),{" "}
            <strong className="font-medium text-ink0">incentives</strong> (an altruism
            score that reshapes a multi-agent equilibrium), and{" "}
            <strong className="font-medium text-ink0">reliability</strong> (a test suite
